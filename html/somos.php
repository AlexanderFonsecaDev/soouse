...
<div class="container">
    ...
    <section>
        <h2 class="titulo">Quienés Somos?</h2>
        <div class="contenedor-quienes">
            <p>SOOUSE Lab es un laboratorio tecnólogico y cientifico enfocado en la idealización, investigación y desarrollo de
                productos de alta tecnología.</p><br>
                <p>Conformada por un equipo de profesionales dedicados y enfocados en el la creación, innovación e idealización de
                    proyectos digitalesconstantemente capacitados en las últimas tecnologías para ofrecer el mejor servicio.
                </p><br>
            <p>Estamos altamnete comprometidos con la calidad de nuestros productos, demostrando el nivel y estrategía aplicada.
                Construimos proyectos basados en:</p>
        </div>
    </section>
    <div class="foot">
        <div class="inf_">
...
<div class="menu-contain">
    <div class="menu-list">
        <ul>
            <a href="index.php"><li class="menu-button draw">Inicio</li></a>
